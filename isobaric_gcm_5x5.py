...
P = np.array([20,50,100,200,300,400,500,600,700,800,900],dtype=float)*100 #Pa
dP = np.array([30,50,100,100,100,100,100,100,100,100])*100 #Pa
dP_stag = np.array([15,50,100,100,100,100,100,100,100,100,100])*100 #Pa
Psponge = 20001
...
#    u_f[:,:,0] = alternative_second_order_shapiro_filter(u_f,1./8)[:,:,0]
#    u_f[:,:,1] = alternative_second_order_shapiro_filter(u_f,1./16)[:,:,1]
#    u_f[:,:,2] = alternative_second_order_shapiro_filter(u_f,1./64)[:,:,2]
#    v_f[:,:,0] = alternative_second_order_shapiro_filter(v_f,1./8)[:,:,0]
#    v_f[:,:,1] = alternative_second_order_shapiro_filter(v_f,1./16)[:,:,1]
#    v_f[:,:,2] = alternative_second_order_shapiro_filter(v_f,1./64)[:,:,2]
    ...
    if n%100 == 0:
        print('Values for time step {}, time {}'.format(n,t))
